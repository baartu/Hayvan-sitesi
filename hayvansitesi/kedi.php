...
<body>
    ...
    <div class="video-background">
        <div class="x">
            <video autoplay muted loop id="background-video" style="filter: blur(5px);">
                <source src="./logo/bg5.mp4" type="video/mp4">
    ...
    <div class="container">
        ...
        $sql = "SELECT * FROM hayvan WHERE hayvan_turu='Kedi'  LIMIT $limit OFFSET $offset"; // Sorguyu oluştur, belirlenen limitle ve ofsetle
        ...
        $sql_count = "SELECT COUNT(*) AS toplam FROM hayvan WHERE hayvan_turu='Kedi'";
